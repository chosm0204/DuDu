...
        {/* 검색창 */}
        <div
          className="mt-8 flex items-center bg-white w-[820px] max-w-full px-8 py-5 rounded-[999px] border-4 border-[#2F7DFF] shadow-sm cursor-text"
...
                }}
                className="px-5 py-3 bg-white border-2 border-[#e7efff] text-gray-600 rounded-full text-lg font-medium shadow-sm hover:border-[#2F7DFF] hover:text-[#2F7DFF] hover:bg-[#e7efff]/30 transition-all transform hover:-translate-y-1"
              >
                {chip}
              </button>
            ))
